...
Ogma supports a number of source languages, including `Copilot <https://github.com/copilot-language/copilot>`_, `FRET <FRET>` and Lustre. The applications can be generated for the Robot Operating System (SpaceROS) and `NASA's Core Flight System (cFS) <https://github.com/nasa/cFS/>`_, among others.
