# -*- coding: utf-8 -*-
#
# Space ROS documentation build configuration file, created by
...
project = 'Space ROS Documentation'
...
html_context = {
    'display_github': True,
    'github_user': 'space-ros',
    'github_repo': 'docs',
    'github_version': 'rolling/source/',  # Will be overridden when building multiversion
}

## Space ROS does not currently require these templates for multiple versions
#templates_path = [
#    "source/_templates",
#]
